...
This section makes explicit what we are and are not claiming, and records the main failure regimes that prevent overclaiming.
...
\begin{itemize}
  ...
  \item \textbf{Kinetic/fluid.} The BGK-like discrete model is a minimal model: it demonstrates moment-lens closure behavior and failure regimes, but it is not a derivation of Navier--Stokes.

  \item \textbf{LES.} Burgers is a minimal nonlinear PDE; the same commutator logic applies in more realistic settings, but quantitative scaling and tensor structure are substantially more complex in 3D turbulence.
...
We list concrete next steps that would strengthen subsequent work without changing its thesis.
\begin{itemize}
...
All generated artifacts (CSV, PNG, and JSON files) are available in the repository and in the archived release. No external datasets were used; all data are produced by the included scripts.

\paragraph{Code availability.}
Source code is available at \url{https://github.com/ioannist/six-birds-physics}.
Archived snapshot: \href{https://doi.org/10.5281/zenodo.18451876}{10.5281/zenodo.18451876}.
