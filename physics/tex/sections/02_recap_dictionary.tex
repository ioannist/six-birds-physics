...
\begin{itemize}
  ...
  \item \textbf{Gravity model (Section~\ref{sec:gravity}):} micro states are heterogeneous ensembles; the lens is averaging/coarse statistics; the completion is a canonical distribution matching those statistics; route mismatch under nonlinear evolution is the backreaction-style diagnostic.
\end{itemize}
